...
const COLOR_DATA: ColorCategory[] = [
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        darkAlias: "Colors/Gray (dark mode)/200",
      ...
      },
      {
        ...
        lightAlias: "Colors/Brand/600",
        darkAlias: "Colors/Gray (dark mode)/50",
        usage: "Alternate brand tertiary text.",
      },
      {
      ...
      {
        name: "text-error-primary_hover",
        lightHex: "#B42318",
        darkHex: "#FDA29B",
        lightAlias: "Colors/Error/700",
        darkAlias: "Colors/Error/300",
        usage: "Error text when in hover state.",
      },
      {
  ...
  },
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        lightAlias: "",
        darkAlias: "Colors/Gray (dark mode)/800",
        usage: "Alternate secondary border.",
      },
      {
      ...
      },
      {
        ...
        lightHex: "#FDA29B",
        darkHex: "#F04438",
        lightAlias: "Colors/Error/300",
        darkAlias: "Colors/Error/500",
        usage: "Subtle error border.",
      },
    ],
  },
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/800",
        darkAlias: "Colors/Gray (dark mode)/200",
        usage: "Secondary foreground hover state.",
      },
      {
        name: "fg-tertiary",
        lightHex: "#3E4784",
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/700",
        darkAlias: "Colors/Gray (dark mode)/300",
        usage: "Tertiary foreground hover state.",
      },
      {
        name: "fg-quaternary",
        lightHex: "#717BBC",
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/500",
        darkAlias: "Colors/Gray (dark mode)/500",
        usage: "Quaternary foreground hover state.",
      },
      {
        name: "fg-white",
        lightHex: "#FFFFFF",
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/300",
        darkAlias: "Colors/Gray (dark mode)/600",
        usage: "Subtle foreground for disabled states.",
      },
      {
      ...
      {
        name: "fg-brand-secondary_subtle",
        lightHex: "#6895F8",
        darkHex: "#88AEFB",
        lightAlias: "Colors/Brand/400",
        darkAlias: "Colors/Brand/300",
        usage: "Subtle secondary brand foreground.",
      },
      {
      ...
      },
      {
        ...
        lightAlias: "Colors/Error/500",
        darkAlias: "Colors/Error/400",
        usage: "Secondary error foreground.",
      },
      {
      ...
      },
      {
        ...
        lightHex: "#F79009",
        darkHex: "#FDB022",
        lightAlias: "Colors/Warning/500",
        darkAlias: "Colors/Warning/400",
        usage: "Secondary warning foreground.",
      },
      {
      ...
      },
      {
        ...
        lightHex: "#17B26A",
        darkHex: "#47CD89",
        lightAlias: "Colors/Success/500",
        darkAlias: "Colors/Success/400",
        usage: "Secondary success foreground.",
      },
    ],
  },
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        lightAlias: "Colors/Base/white",
        darkAlias: "",
        usage: "Alternate primary background.",
      },
      {
        ...
        darkAlias: "Colors/Gray (dark mode)/800",
        usage: "Primary background hover state.",
      },
      {
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/50",
        darkAlias: "",
        usage: "Alternate secondary background.",
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/100",
        darkAlias: "Colors/Gray (dark mode)/800",
        usage: "Secondary background hover state.",
      },
      {
        name: "bg-secondary_subtle",
        lightHex: "#FCFCFD",
        darkHex: "#111322",
        lightAlias: "Colors/Gray (light mode)/25",
        darkAlias: "Colors/Gray (dark mode)/900",
        usage: "Subtle secondary background.",
      },
      {
      ...
      },
      {
        ...
        lightAlias: "Colors/Gray (light mode)/50",
        darkAlias: "Colors/Gray (dark mode)/800",
        usage: "Background for active/selected items.",
      },
      {
        name: "bg-disabled",
        lightHex: "#EAECF5",
      ...
      },
      {
        ...
        lightHex: "#0D0F1C",
        darkHex: "#30374F",
        lightAlias: "Colors/Gray (light mode)/950",
        darkAlias: "Colors/Gray (dark mode)/800",
        usage: "Semi-transparent overlay background.",
      },
      {
      ...
      },
      {
        ...
        lightAlias: "Colors/Brand/50",
        darkAlias: "",
        usage: "Alternate brand primary background.",
      },
      {
      ...
      },
      {
        ...
        lightAlias: "Colors/Brand/700",
        darkAlias: "Colors/Brand/500",
        usage: "Brand solid background hover state.",
      },
      {
      ...
      },
      {
        ...
        darkHex: "#1234D1",
        lightAlias: "Colors/Brand/700",
        darkAlias: "Colors/Brand/700",
        usage: "Subtle brand section background.",
      },
      {
        ...
        usage: "Light error background for alerts.",
      },
      {
        name: "bg-error-secondary",
        lightHex: "#FEE4E2",
        darkHex: "#D92D20",
        lightAlias: "Colors/Error/100",
        darkAlias: "Colors/Error/600",
        usage: "Secondary error background.",
      },
      {
        name: "bg-error-solid",
        lightHex: "#D92D20",
      ...
      },
      {
        ...
        lightAlias: "Colors/Error/700",
        darkAlias: "Colors/Error/500",
        usage: "Error solid background hover state.",
      },
      {
        ...
        usage: "Light warning background.",
      },
      {
        name: "bg-warning-secondary",
        lightHex: "#FEF0C7",
        darkHex: "#DC6803",
        lightAlias: "Colors/Warning/100",
        darkAlias: "Colors/Warning/600",
        usage: "Secondary warning background.",
      },
      {
        ...
        lightAlias: "Colors/Warning/600",
        darkAlias: "Colors/Warning/600",
        usage: "Solid warning background.",
      },
      {
        ...
        usage: "Light success background.",
      },
      {
        name: "bg-success-secondary",
        lightHex: "#DCFAE6",
        darkHex: "#079455",
        lightAlias: "Colors/Success/100",
        darkAlias: "Colors/Success/600",
        usage: "Secondary success background.",
      },
      {
        ...
        lightAlias: "Colors/Success/600",
        darkAlias: "Colors/Success/600",
        usage: "Solid success background.",
      },
    ],
  },
]
