          ...
          >
            ...
            <View style={{ alignItems: "center", gap: 20 }}>
              ...
              >
                ...
                {" — Every component, every screen generated by Cursor AI from production Figma designs. "}
                <Typography
                  size="body"
                  weight="bold"
                  style={{
                ...
                >
                  99% design fidelity, minimal tweaks.
                </Typography>
              </Typography>
            </View>
            ...
            >
              {[
                { value: "100%", label: "Vibe Coded", color: "#10b981" },
