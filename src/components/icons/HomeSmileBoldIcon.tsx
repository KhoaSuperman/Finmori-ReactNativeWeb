...
export function HomeSmileBoldIcon({ size = 24, color, ...props }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
      <Path
        ...
        fill={useGradient ? "url(#home_bold_grad)" : color}
      />
      {useGradient && (
        <Defs>
          <LinearGradient id="home_bold_grad" x1="2" y1="22" x2="22" y2="2" gradientUnits="userSpaceOnUse">
