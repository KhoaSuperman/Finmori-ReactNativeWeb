...
export function UserCircleOutlineIcon({ size = 24, color, ...props }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
      <Path
        ...
        fill={useGradient ? "url(#user_outline_grad)" : color}
      />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      {useGradient && (
        <Defs>
          <LinearGradient id="user_outline_grad" x1="1.25" y1="1.25" x2="22.75" y2="22.75" gradientUnits="userSpaceOnUse">
